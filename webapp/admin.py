...
from .models import Employee2, Tool, NewJob, Job, NewMachine, Machine, Performs, Breakdown, Reviving1,ToolChart, Shift,ShiftEfficiency,Auth,SignAuth,Externals
